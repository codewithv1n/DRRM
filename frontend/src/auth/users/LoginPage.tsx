...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Save resident data to sessionStorage
            sessionStorage.setItem('resident', JSON.stringify(data.resident));
