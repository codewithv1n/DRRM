      ...
      <aside className={`fixed lg:sticky top-0 h-screen z-50 bg-white flex flex-col w-64 shrink-0 transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <div className="p-5 flex items-center gap-3 border-b border-slate-100">
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            <p className="text-[12px] text-slate-500 font-medium truncate">Field Unit</p>
          </div>
        </div>

        <div className="flex-1 overflow-y-auto px-3 py-5 space-y-1">
          <div className="px-3 pt-2 pb-2 text-[11px] uppercase font-semibold tracking-widest text-slate-400">Main</div>
          <button className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl bg-orange-50 text-orange-600 font-semibold cursor-pointer">
          ...
          <div className="flex items-center justify-between p-2 rounded-xl hover:bg-slate-50 transition-colors cursor-pointer group">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-slate-800">Rescue Team A</span>
                <span className="text-xs text-slate-500 truncate w-24">QC Task Force</span>
              </div>
            </div>
