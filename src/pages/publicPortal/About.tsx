    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 font-sans text-slate-800">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100 relative">
        ...
        <div className="bg-primary p-6 text-center text-white relative">
          ...
          <h1 className="text-2xl font-bold text-white">About GOVSERVE</h1>
          <p className="text-blue-100 text-sm mt-1">Learn more about our system and mission</p>
        </div>

        <div className="p-6">
          <div className="mb-6 text-center">
            <h2 className="text-xl font-bold text-slate-800 mb-2">GOVSERVE</h2>
            <p className="text-slate-500 leading-relaxed text-sm">
              The Disaster Risk Reduction and Emergency Response system is a comprehensive platform designed to streamline emergency responses, manage resources effectively, and foster resilient communities. 
            </p>
          </div>
